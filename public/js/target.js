...
var tarjetas = [
	{
		coleccion: "Premium",
		imagen: "./img/generation1/00-pemium-first.png",
	...
	// Agrega más objetos con la información de cada tarjeta según sea necesario
];
...
for (var coleccion in grupos) {
	if (grupos.hasOwnProperty(coleccion)) {
			...
			tarjeta.innerHTML = `
				...
				<div class="flex justify-center text-lg font-bold">
					...
					${
						...
						tarjetaInfo.status === "Available" ? 
						`<a href="${tarjetaInfo.enlaceCompra}" target="_blank" rel="noopener noreferrer">
